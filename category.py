...
class categoryClass:
    def __init__(self, root):
        ...
        # ---------------images--------------------------
        self.im1 = Image.open("images/inventory.png")
        ...
        self.im2 = Image.open("images/management.png")
    ...
    def add(self):
             ...
             try:
                 if self.var_name.get() == "":
                     messagebox.showerror("Error", "Category Name MUST be keyed ", parent=self.root)
                 else:
