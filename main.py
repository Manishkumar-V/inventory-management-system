...
class IMS:
    def __init__(self, root):
        ...
        title = Label(self.root, text="Inventory Management System", image=self.icon_title, compound=LEFT, font=("times new roman", 40, "bold"), bg="#010c48", fg="white", anchor="w", padx=20).place(x=0, y=0, relwidth=1, height=100)
        ...
        # ---------clock--------------------
        self.lbl_clock = Label(self.root, text="Welcome to Inventory Management System\t\t Date: DD-YYYY\t\t Time: HH:MM:SS", font=("barnum", 15, "bold"), bg="#4d636d", fg="white")
        ...
        LeftMenu = Frame(self.root, bd=2, relief=RIDGE, bg="pink")
        LeftMenu.place(x=0, y=102, width=200, height=565)

        self.icon_side=PhotoImage(file="images/smallicon10.png")

        lbl_menu = Label(LeftMenu, text="Menu", font=("barnum", 20, "bold"), bg="#009688").pack(side=TOP, fill=X)
        ...
        # ---------footer--------------------
        lbl_footer = Label(self.root, text="IMS-inventory Management System", font=("times new roman", 15), bg="#4d636d", fg="pink").pack(side=BOTTOM, fill=X)
