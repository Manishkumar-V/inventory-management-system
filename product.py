...
class productClass:
    def __init__(self, root):
        ...
        self.product_table.heading("Customer", text="Customer")
        ...
        try:
            if self.var_cat.get() == "Select" or self.var_cat.get() == "Empty" or self.var_cus.get() == "Select" or self.var_name.get() == "":
                ...
                if row!=None:
                    ...
                    cur.execute("Insert into product (Category, Customer, name, price, qty, status) values(?,?,?,?,?,?)",(
                                              self.var_cat.get(),
                                              self.var_cus.get(),
                                              self.var_name.get(),
                                              self.var_price.get(),
        ...
        try:
            if self.var_pid.get() == "":
                ...
                if row==None:
                    ...
                    cur.execute("Update product set Category=?, Customer=?, name=? ,price=?, qty=?,status=? where pid=?",(
                        self.var_cat.get(),
                        self.var_cus.get(),
                        self.var_name.get(),
                        self.var_price.get(),
